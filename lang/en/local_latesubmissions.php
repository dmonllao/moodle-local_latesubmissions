...
$string['timesplitting:reallyclosetodeadline'] = 'From start to two days before the end';
$string['timesplitting:reallyclosetodeadline_help'] = 'This time-splitting method generates predictions 2 days before the analysable end date or due date using the data generated from the start of the course.';
