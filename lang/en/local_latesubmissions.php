...
$string['forumdiscussions'] = 'Forum discussions';
$string['forumdiscussions_help'] = 'Forum discussions';
$string['forumposts'] = 'Forum posts';
$string['forumposts_help'] = 'Forum posts';
...
$string['timesplitting:reallyclosetodeadline_help'] = 'This time-splitting method generates predictions 2 days before the analysable end date.';
$string['useractivity'] = 'User activity';
$string['useractivity_help'] = 'User activity';
