 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class forum_posts extends \core_analytics\local\indicator\linear {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('forumposts', 'local_latesubmissions');
    }
    ...
    protected function calculate_sample($sampleid, $sampleorigin, $starttime = false, $endtime = false) {
        ...
        // Posts presence indexed by context.
        $posts = [];
        ...
        $params = array('userid' => $user->id, 'contextlevel' => CONTEXT_MODULE,
            'crud' => 'u', 'eventname' => '\mod_forum\event\post_created') + $ctxparams;
        ...
        foreach ($logs as $log) {
            $posts[$log->contextinstanceid] = true;
        }

        return ((count($posts) / count($forums)) * 2) - 1;
    }
}
